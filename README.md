...
You can download the entire haunted data compilation here: <a id="raw-url" href="[data/KY_haunted_places.csv](https://rawgithubusercontent.com/DTAbeyrathne/KY-spooks/raw/main/data/KY_haunted_places.csv)" download>KY_haunted_places.csv</a>
